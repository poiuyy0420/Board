...
public class BoardDAO {
	...
	///////////// 이곳에 게시판 작업의 기능 하나하나를 메소드로 추가 할 것 /////////////
		...
		try {
			...
			if(rs.next()) {
				...
				do {
					...
					article.setReadcount(rs.getShort("readcount"));
					article.setRef(rs.getInt("ref"));
					article.setStep(rs.getInt("depth"));
